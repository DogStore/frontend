          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <span class="text-sm font-semibold text-orange-500 group-hover:text-orange-600">Add images</span>
              ...
              <div v-if="imagePreviews.length" class="grid grid-cols-4 gap-3 mt-3">
                <div v-for="(preview, index) in imagePreviews" :key="index" class="relative group">
                  <img :src="preview" class="w-full h-20 object-cover rounded-lg border-2 border-gray-200 shadow-sm" />
                  <button
                    type="button"
            ...
            <div>
              ...
              <div v-if="flagPreview" class="relative w-24 mb-3 group">
                <img :src="flagPreview" class="w-24 h-16 object-cover rounded-lg border-2 border-gray-200 shadow-sm" />
                <button
                  type="button"
                  @click="removeFlag"
                  class="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-red-500 hover:bg-red-600 text-white text-sm font-bold flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition"
              ...
              >
                ...
                <span class="text-sm font-semibold text-orange-500 group-hover:text-orange-600">Upload flag</span>
