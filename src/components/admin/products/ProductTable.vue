...
const totalPages = computed(() => Math.ceil(props.products.length / pageSize))
        ...
        >
          ...
          <td class="px-6 py-4">
            <img
              :src="
                product.images[0] ||
                'https://projectfba.com/wp-content/webp-express/webp-images/doc-root/wp-content/uploads/2021/07/no-image-logo.jpg.webp'
              "
              alt="Product"
